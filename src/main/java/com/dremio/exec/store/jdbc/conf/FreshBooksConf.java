...
@SourceType(value = "FreshBooksARP", label = "FreshBooks",uiConfig = "freshbooks-layout.json")
public class FreshBooksConf extends AbstractArpConf<FreshBooksConf> {
  private static final String ARP_FILENAME = "arp/implementation/freshbooks-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.freshbooks.FreshBooksDriver";
